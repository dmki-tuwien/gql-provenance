...
public class Edge implements Entity {
    ...
    public Edge(String elementId, String label, Map<String, Object> properties) {
    ...
    public Object getAnnotation() {
        String key = Globals.EDGE_ANNOT_KEY;
    ...
    public Object getTypedAnnotation(String typeName) {
        ...
        String key = Globals.NODE_ANNOT_KEY + typeName;
    ...
    public Object getLabelAnnotation(String labelName) {
        ...
        if (properties.containsKey(key)) {
            return properties.get(key);
        } else if (Objects.equals(labelName, label)) {
            throw new RuntimeException("Provenance annotations not found");
        }
        return null;
    }

...
## Copied from https://github.com/ldbc/ldbc_snb_interactive_v1_impls/blob/main/cypher/scripts/convert-csvs.sh
...
NEO4J_VANILLA_CSV_DIR=$1/snb/social_network-sf$2-CsvBasic-LongDateFormatter
# $1 = /data/pgprov
# $2 = scale_factor
NEO4J_CONVERTED_CSV_DIR=$NEO4J_VANILLA_CSV_DIR/converted
